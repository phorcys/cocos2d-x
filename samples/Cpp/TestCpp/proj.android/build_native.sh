APPNAME="FindGame"
NDK_ROOT=/cygdrive/d/da/android-ndk-r9b
# options
...
NDK_MODULE_PATH=${COCOS2DX_ROOT}/cocos:${COCOS2DX_ROOT}:${COCOS2DX_ROOT}/external:${COCOS2DX_ROOT}/extensions

echo NDK_MODULE_PATH=${NDK_MODULE_PATH}:

if [[ "$buildexternalsfromsource" ]]; then
    echo "Building external dependencies from source"
    "$NDK_ROOT"/ndk-build NDK_TOOLCHAIN_VERSION=4.8 -C "$APP_ANDROID_ROOT" $* \
...
/cygdrive/c/tools/apache-ant-1.8.4/bin/ant debug
/cygdrive/c/tools/apache-ant-1.8.4/bin/ant installd